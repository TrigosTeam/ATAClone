...
```{r}
leiden_clusters <- iterative_cluster_sim(stable_counts_filtered, nb_overdispersion, npcs, discard_pcs, knn_k, tolerance = 0.05)
...
doublet_thresholds <- c(10 ** 3.7, 10 ** 3.7, 10 ** 3.7, 10 ** 3.85)
```
...
#### Code
```{r}
cn_fit_out <- fit_cn_clusters(stable_counts_filtered, leiden_clusters, 4, F, cluster_outliers | is_doublet, 1000, 0.7, 2, 0.025, T, T)
